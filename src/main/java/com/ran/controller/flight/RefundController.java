...
import com.ran.service.flight.RefundService;
 ...
 */
@Controller
@RequestMapping(value="/flight/refund")
public class RefundController extends BaseController {
	
	String menuUrl = "flight/refund/list.do"; //菜单地址(权限用)
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("flight/refund/refund_list");
	...
	public ModelAndView goAdd(){
		logBefore(logger, "去新增Refund页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
			mv.setViewName("flight/refund/refund_edit");
	...
	public ModelAndView exportExcel(){
		logBefore(logger, "导出Refund到excel");
