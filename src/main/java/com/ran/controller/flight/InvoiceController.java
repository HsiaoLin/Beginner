...
import com.ran.service.flight.InvoiceService;

/** 
 * 类名称：InvoiceController
 * 创建时间：2015-08-07
 */
@Controller
@RequestMapping(value="/flight/invoice")
public class InvoiceController extends BaseController {
	
	String menuUrl = "flight/invoice/list.do"; //菜单地址(权限用)
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("flight/invoice/invoice_list");
	...
	public ModelAndView goAdd(){
		logBefore(logger, "去新增Invoice页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
			mv.setViewName("flight/invoice/invoice_edit");
	...
	public ModelAndView exportExcel(){
		logBefore(logger, "导出Invoice到excel");
