package com.ran.controller.system.role;
...
import com.ran.util.RightsHelper;
...
//			mv.addObject("roleList_z", roleList_z);
	...
	public String auth(@RequestParam String ROLE_ID,Model model)throws Exception{
		...
		try{
			...
			String roleRights = role.getRights().get(0);
...
//					role.setRIGHTS(rights.toString());
					...
					Role role = new Role();
//					role.setRIGHTS("");
					role.getRights().add(0, "");
					role.setRoleId(Integer.valueOf(ROLE_ID));
					roleService.updateRoleRights(role);
					pd.put("rights","");
				}
