...
public class SimpleMailSender extends BaseController {
	...
	public static void main(String[] args) throws Exception {
		...
		mailInfo.setMailServerPort("25");
		mailInfo.setValidate(true);
		mailInfo.setUserName("zhaoyongbing@shijie99.com");
		mailInfo.setPassword("ba29147190");//您的邮箱密码    
		mailInfo.setFromAddress("zhaoyongbing@shijie99.com");
		mailInfo.setToAddress("476223177@qq.com");
