...
public class Jurisdiction {
	...
	public static boolean hasJurisdiction(String menuUrl) {
		...
		// Boolean b = true;
		// List<Menu> menuList =
		// (List)session.getAttribute(Const.SESSION_allmenuList); //获取菜单列表
		//
		...
		// String>)session.getAttribute(Const.SESSION_QX);//按钮权限
		// map.remove("add");
		// map.remove("del");
		// map.remove("edit");
		// map.remove("cha");
	...
	public static boolean buttonJurisdiction(String menuUrl, String type) {
		...
		// Boolean isAdmin = "admin".equals(USERNAME);
		// if("add".equals(type)){
		// return ((RightsHelper.testRights(map.get("adds"), MENU_ID)) ||
		// isAdmin);
		// }else if("del".equals(type)){
		// return ((RightsHelper.testRights(map.get("dels"), MENU_ID)) ||
		// isAdmin);
		// }else if("edit".equals(type)){
		// return ((RightsHelper.testRights(map.get("edits"), MENU_ID)) ||
		// isAdmin);
		// }else if("cha".equals(type)){
		// return ((RightsHelper.testRights(map.get("chas"), MENU_ID)) ||
		// isAdmin);
		// }
		// }
		// }
