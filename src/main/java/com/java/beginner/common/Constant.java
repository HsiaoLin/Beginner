...
public class Constant {
	...
	public static final String SESSION_ALL_MENULIST = "allmenuList"; // 全部菜单
	...
	public static final String LOGIN = "/login/to_login"; // 登录地址
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(api)|(static)|(main)|(register)).*"; // 不对匹配该值的访问路径拦截（正则）
