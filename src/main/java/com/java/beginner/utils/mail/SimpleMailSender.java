package com.java.beginner.utils.mail;
...
public class SimpleMailSender extends BaseController {
	...
	public static void main(String[] args) throws Exception {
		//这个类主要是设置邮件   
		MailSenderInfo mailInfo = new MailSenderInfo();
		mailInfo.setMailServerHost("smtp.shijie99.com");
		mailInfo.setMailServerPort("25");
		mailInfo.setValidate(true);
		mailInfo.setUserName("yinxiaoling@shijie99.com");
		mailInfo.setPassword("ling@4537228");//您的邮箱密码    
		mailInfo.setFromAddress("yinxiaoling@shijie99.com");
		mailInfo.setToAddress("691488273@qq.com");
