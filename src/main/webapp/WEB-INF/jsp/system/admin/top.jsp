	...
	<!-- 网站图标 -->
	<link rel="icon" href="static/avatars/favicon.ico" type="image/x-icon" />
	<link rel="bookmark" href="static/avatars/favicon.ico" type="image/x-icon" />
	<link rel="shortcut icon" href="static/avatars/favicon.ico" type="image/x-icon" />
