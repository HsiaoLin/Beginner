...
<body>
	<form action="system/user/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">父用户ID:</td>
				<td><input type="number" name="PARENT_ID" id="PARENT_ID" value="${pd.PARENT_ID}" maxlength="32" placeholder="这里输入父用户ID" title="父用户ID"/></td>
			</tr>
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">最后登陆时间:</td>
				<td><input type="text" name="LAST_LOGIN" id="LAST_LOGIN" value="${pd.LAST_LOGIN}" maxlength="32" placeholder="这里输入最后登陆时间" title="最后登陆时间"/></td>
			</tr>
			<tr>
