...
<div class="row-fluid">
	<div class="row-fluid">
		<form action="${packageName}/${objectNameLower}/list" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
...
<script type="text/javascript">
	...
	function add(){
		...
		diag.Drag=true;
		diag.Title ="新增";
		diag.URL = '<%=basePath%>${packageName}/${objectNameLower}/goAdd';
		diag.Width = 450;
		diag.Height = 355;
	...
	function edit(Id){
		...
		diag.Drag=true;
		diag.Title ="编辑";
		diag.URL = '<%=basePath%>${packageName}/${objectNameLower}/goEdit?${objectNameUpper}_ID='+Id;
		diag.Width = 450;
		diag.Height = 355;
		diag.CancelEvent = function(){ //关闭事件
			if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
	...
	//导出Excel
	function toExcel(){
		window.location.href='<%=basePath%>${packageName}/${objectNameLower}/excel';
	}
</script>
<script type="text/javascript">
	$(function() {
