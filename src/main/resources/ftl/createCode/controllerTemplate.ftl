package com.tour.controller.${packageName};
...
import com.tour.entity.Page;
import com.tour.util.AppUtil;
import com.tour.util.ObjectExcelView;
import com.tour.util.Const;
import com.tour.util.PageData;
import com.tour.util.Tools;
import com.tour.util.Jurisdiction;
import com.tour.service.${packageName}.${objectNameLower}.${objectName}Service;
...
public class ${objectName}Controller extends BaseController {
	...
	String menuUrl = "${packageName}/${objectNameLower}/list.do"; //菜单地址(权限用)
